...
export default function ReviewPage() {
  ...
  const handleComplete = async () => {
    try {
      ...
      const vendorData: Partial<Vendor> = Object.entries(vendor).reduce(
        (acc, [key, value]) => {
          if (value !== undefined) {
          ...
          images.map(async (image, index) => {
            if (image instanceof File) {
              ...
              return await uploadFile(
                image,
                `vendor-images/${user.uid}/${fileName}`,
              );
            }
      ...
      <div className={styles.form}>
        ...
        <div className={styles.formGroup}>
          ...
          <div className={styles.reviewText}>
            {vendor.categories?.join(", ") || "No categories selected"}
          </div>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <div className={styles.reviewText}>
            {vendor.hasOwnSetup === true
              ? "Has own setup"
              : vendor.hasOwnSetup === false
        ...
        <div className={styles.formGroup}>
          ...
          <div className={styles.reviewText}>
            Maximum Vendor Fee: $
            {vendor.budget?.maxVendorFee || "Not specified"}
          </div>
          <div className={styles.reviewText}>
            Expected Event Spending: $
            {vendor.budget?.totalCostEstimate || "Not specified"}
          </div>
        </div>
        ...
        <div className={styles.buttonContainer}>
          <button className={styles.secondaryButton} onClick={handlePrevious}>
            Previous
          </button>
