...
export default function EmailValidatorPage() {
  return (
    ...
    >
      ...
      >
        This page checks that your authentication email (the one you use to log
        in) matches the email in your vendor profile. This ensures that only you
        can access your vendor account.
      </p>
      ...
      >
        ...
        >
          ...
          <li style={{ marginBottom: "0.5rem" }}>
            Your authentication email and vendor profile email must match to
